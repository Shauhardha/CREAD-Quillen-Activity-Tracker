...
A full-stack web app for tracking and visualizing community engagement activities for the  
**Center for Rural Education and Development (CREAD)** and the  
**Quillen Chair of Excellence in Teaching and Learning** at ETSU.
...
- 📊 Manage activities  
- 📈 Track progress  
- 🌎 Understand impact across initiatives  

All through dashboards, maps, and reports in one place.
...
- Cognito config should be provided locally or via secrets  
...
Developed for East Tennessee State University.  
All rights reserved.
