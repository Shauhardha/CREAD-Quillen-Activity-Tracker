                                ...
                                <table className="min-w-full divide-y divide-gray-200 table-fixed w-full">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            {!isReadOnly && <th className="px-4 py-2 text-right text-sm font-medium text-gray-500">Actions</th>}
                                        </tr>
                                    </thead>
                                                ...
                                                {!isReadOnly && (
                                                  <td className="px-4 py-2 align-top">
                                                      <div className="flex justify-end gap-1">
                                                          <button onClick={() => handleEdit(it)} className="px-3 py-1 rounded text-base text-blue-600">
                                                              <FaEdit />
                                                          </button>
                                                          <button onClick={() => handleDelete(it)} className="px-3 py-1 text-red-600 rounded text-base">
                                                              <FaTrash />
                                                          </button>
                                                      </div>
                                                  </td>
